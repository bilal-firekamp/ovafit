...
<?php if ('yes' === get_option('woocommerce_enable_myaccount_registration')) : ?>
	<div class="u-columns col2-set" id="customer_login">
		...
		<div class="vc_row wpb_row vc_row-no-padding vc_row-fluid" data-vc-full-width="true" data-vc-full-width-init="false" data-vc-stretch-content="true">
			...
			<div class="vc_col-md-7 wpb_column vc_column_container myaccount-login-form">
				<div class="norebro-tabs-sc tab-box tab-box_login tabs-center" id="norebro-5b28a6d084e39" data-norebro-tab-box="true" data-options="{}">
					<div class="buttons-wrap">
						<div class="buttons <?php if (get_option('woocommerce_enable_myaccount_registration') === 'no') {
												echo single;
											} ?>" role="tablist">
							<div class="line brand-bg-color" style="width: 60px; transform: translateX(0px);"></div>

							<h2 class="button active second-title text-left">
								<?php esc_html_e('Login', 'norebro'); ?>
							</h2>

							<?php if (get_option('woocommerce_enable_myaccount_registration') === 'yes') { ?>
								<h2 class="button title text-left">
									<span>|</span> <?php esc_html_e('Create An Account', 'norebro'); ?>
								</h2>
							<?php } ?>
						</div>
					</div>
					...
					<div class="items" role="tabpanel">
						<div class="item active" data-title="<?php esc_html_e('Sign In', 'norebro'); ?>">
							<h3 class="second-title">Login</h3>
							<form method="post" class="login">
								...
								<p class="form-row">
									...
									<a class="lost-link left" href="<?php echo esc_url(wp_lostpassword_url()); ?>"><?php esc_html_e('Forget Password?', 'norebro'); ?></a>
						...
						<?php if (get_option('woocommerce_enable_myaccount_registration') === 'yes') : ?>
							<div class="item" data-title="<?php esc_html_e('Registration', 'norebro'); ?>">
								<h3 class="second-title">Create An Account</h3>
								...
								<form method="post" class="register">
									...
									<p class="woocomerce-FormRow form-row">
										...
										<input type="submit" class="woocommerce-Button btn" name="register" value="<?php esc_attr_e('Create An Account', 'norebro'); ?>" />
									</p>
