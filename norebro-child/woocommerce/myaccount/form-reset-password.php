...
<div class="vc_row wpb_row vc_row-no-padding vc_row-fluid" data-vc-full-width="true" data-vc-full-width-init="false" data-vc-stretch-content="true">
	...
	<div class="vc_col-md-7 tab-box_login">
		<form method="post" class="woocommerce-ResetPassword lost_reset_password">
			...
			<p class="woocommerce-FormRow woocommerce-FormRow--first form-row form-row-first">
				...
				<input type="password" class="woocommerce-Input woocommerce-Input--text input-text" placeholder="New password" name="password_1" id="password_1" />
			</p>
			<p class="woocommerce-FormRow woocommerce-FormRow--last form-row form-row-last">
				<label for="password_2"><?php esc_html_e('Re-enter new password', 'norebro'); ?> <span class="required">*</span></label>
				<input type="password" class="woocommerce-Input woocommerce-Input--text input-text" class="New password" name="password_2" id="password_2" />
			</p>
